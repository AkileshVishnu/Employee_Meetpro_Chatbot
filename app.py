...
def generate_personalized_summary(data, transcript):
    ...
    prompt = PromptTemplate(
        input_variables=["EmployeeName", "Email", "JobLevel", "RoleType", "DepartmentID", "SupervisorID", "CurrentProjectID", "ProjectDetails", "Transcript"],
        template=template
    )
...
# Main Streamlit App
def main():
    st.set_page_config(page_title="Employee AgentOPS", layout="wide")
